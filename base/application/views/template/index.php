...
<html lang="en">
  <head>
	...
	<link rel="icon" href="<?php echo base_url()."assets/dashboard/"; ?>production/images/favicon.ico" type="image/ico" />
              ...
              <ul class=" navbar-right">
                <li class="nav-item dropdown open" style="padding-left: 15px;">
                  <a href="javascript:;" class="user-profile dropdown-toggle" aria-haspopup="true" id="navbarDropdown" data-toggle="dropdown" aria-expanded="false">
                    <img src="<?php echo base_url()."assets/dashboard/"; ?>production/images/img.jpg" alt="">John Doe
                  </a>
                  ...
                  <ul class="dropdown-menu list-unstyled msg_list" role="menu" aria-labelledby="navbarDropdown1">
                    <li class="nav-item">
                      <a class="dropdown-item">
                        <span class="image"><img src="<?php echo base_url()."assets/dashboard/"; ?>production/images/img.jpg" alt="Profile Image" /></span>
                        <span>
